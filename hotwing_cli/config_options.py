...
CONFIG_OPTIONS = {
    ...
    'RootChord':{   "Profile":{"type":str,"required":True},
                    ...
                    "LeadingEdgeOffsetX":{"type":float,"required":False,"default":0},
                    "LeadingEdgeOffsetY":{"type":float,"required":False,"default":0},
                    "Rotation":{"type":float,"required":False,"default":0},
                    "RotationPosition":{"type":float,"required":False,"default":0},
                    "SparOffsetX":{"type":float, "required":False, "default": 0},
                    "SparOffsetY":{"type":float, "required":False, "default": 0},
                    "SparRadius":{"type":float, "required":False, "default": 0},
                },
